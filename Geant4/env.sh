...
if [ X/home/jason/geant4/geant4.9.4.p01 != X/home/jason/geant4/geant4.9.4.p01 ] ; then
    G4INSTALL="/home/jason/geant4/geant4.9.4.p01/src/geant4"
else
    G4INSTALL="/home/jason/geant4/geant4.9.4.p01"
fi
export G4INSTALL
if [ X$g4non_display = X ] ; then
...
if [ Xn != Xn ] ; then 
    if [ X/home/jason/geant4/geant4.9.4.p01 != X/home/jason/geant4/geant4.9.4.p01 ] ; then
        G4INCLUDE="/home/jason/geant4/geant4.9.4.p01/include/geant4"
    else
        G4INCLUDE="/home/jason/geant4/geant4.9.4.p01/include/"
    fi
    export G4INCLUDE
    if [ X$g4non_display = X ] ; then
...
if [ X/home/jason/geant4/geant4.9.4.p01/lib != X ] ; then 
    if [ X/home/jason/geant4/geant4.9.4.p01 != X/home/jason/geant4/geant4.9.4.p01 ] ; then
        G4LIB="/home/jason/geant4/geant4.9.4.p01/lib/geant4"
    else
        G4LIB="/home/jason/geant4/geant4.9.4.p01/lib"
    fi
    export G4LIB
    if [ X$g4non_display = X ] ; then
...
if [ X/home/jason/geant4/geant4.9.4.p01/data/PhotonEvaporation2.1 != X ] ; then 
    G4LEVELGAMMADATA="/home/jason/geant4/geant4.9.4.p01/data/PhotonEvaporation2.1"
...
if [ X/home/jason/geant4/geant4.9.4.p01/data/RadioactiveDecay3.3 != X ] ; then 
    G4RADIOACTIVEDATA="/home/jason/geant4/geant4.9.4.p01/data/RadioactiveDecay3.3"
...
if [ X/home/jason/geant4/geant4.9.4.p01/data/G4EMLOW6.19 != X ] ; then 
    G4LEDATA="/home/jason/geant4/geant4.9.4.p01/data/G4EMLOW6.19"
    export G4LEDATA
    if [ X$g4non_display = X ] ; then
...
if [ X/home/jason/geant4/geant4.9.4.p01/data/G4NDL3.14 != X ] ; then 
    G4NEUTRONHPDATA="/home/jason/geant4/geant4.9.4.p01/data/G4NDL3.14"
...
if [ X/home/jason/geant4/geant4.9.4.p01/data/G4ABLA3.0 != X ] ; then 
    G4ABLADATA="/home/jason/geant4/geant4.9.4.p01/data/G4ABLA3.0"
    export G4ABLADATA
    if [ X$g4non_display = X ] ; then
...
if [ X/home/jason/geant4/geant4.9.4.p01/data/RealSurface1.0 != X ] ; then 
    G4REALSURFACEDATA="/home/jason/geant4/geant4.9.4.p01/data/RealSurface1.0"
...
if [ X/home/jason/geant4/geant4.9.4.p01/data/G4NEUTRONXS1.0 != X ] ; then 
    G4NEUTRONXSDATA="/home/jason/geant4/geant4.9.4.p01/data/G4NEUTRONXS1.0"
...
if [ X/home/jason/geant4/geant4.9.4.p01/data/G4PII1.2 != X ] ; then 
    G4PIIDATA="/home/jason/geant4/geant4.9.4.p01/data/G4PII1.2"
    export G4PIIDATA
    if [ X$g4non_display = X ] ; then
...
if [ X/home/jason/CLHEP != X ] ; then 
    CLHEP_BASE_DIR="/home/jason/CLHEP"
...
if [ X/home/jason/CLHEP/include != X ] ; then 
    CLHEP_INCLUDE_DIR="/home/jason/CLHEP/include"
...
if [ X/home/jason/CLHEP/lib != X ] ; then 
    CLHEP_LIB_DIR="/home/jason/CLHEP/lib"
