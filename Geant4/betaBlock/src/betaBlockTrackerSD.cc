...
betaBlockTrackerSD::betaBlockTrackerSD(G4String name,bool hf)
...
betaBlockTrackerSD::~betaBlockTrackerSD(){ }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void betaBlockTrackerSD::Initialize(G4HCofThisEvent* HCE)
{
...
G4bool betaBlockTrackerSD::ProcessHits(G4Step* aStep,G4TouchableHistory*)
{
...
void betaBlockTrackerSD::EndOfEvent(G4HCofThisEvent*)
{
	...
	//if(energy > 600)
	RootIO::GetInstance()->CountDeposit(energy,numphotons);
	energy = 0;
	numphotons = 0;
