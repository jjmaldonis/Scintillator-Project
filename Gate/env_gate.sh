# Open-GATE:
export OPENGATE_HOME=/home/jason/Gate5

export     GATEHOME=${OPENGATE_HOME}/my_gate_v6.1
export     G4VERSION="9.4"
export     G4INSTALL=/home/jason/geant4/geant4.9.4.p01
export     ECAT7_HOME=${OPENGATE_HOME}/ecat_7
export     LMF_HOME=${OPENGATE_HOME}/lmf_v3.0
export     ROOTSYS=${ROOTSYS}

export     PATH=${ROOTSYS}/bin:${GATEHOME}/bin/Linux-g++:${GATEHOME}/tmp/Linux-g++/Gate:${PATH}

#not sure if i need the following line. see http://wiki.opengatecollaboration.org/index.php/InstallationGuide
export     PATH=$PATH:$ROOTSYS/lib:$GATEHOME/bin/$G4SYSTEM


# VRML viewer :
#export  G4VRMLFILE_VIEWER=/opt/vrmlview/vrmlview

if [ -n "$LD_LIBRARY_PATH" ] ; then
  export LD_LIBRARY_PATH=${ROOTSYS}/lib:/home/jason/CLHEP/lib:${OPENGATE_HOME}/gate_v5.0.0_p01/tmp/Linux-g++/Gate:${LD_LIBRARY_PATH}
else
  export LD_LIBRARY_PATH=${ROOTSYS}/lib:/home/jason/CLHEP/lib
fi
...
if [ -n "$ECAT7_HOME" ] ; then
  if [ -d $ECAT7_HOME ] ; then
	...
	#	echo "==> OK: The ECAT7 home directory is set. Btw, i put this echo line in the env_gate.sh file"
  else
